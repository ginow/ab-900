...
\textbf{Explanation:} Admins use Purview’s advanced capabilities to assess their organization’s compliance posture and gain visibility into how data is used, shared, and accessed, especially as AI-driven workflows become more prevalent.

\item Compliance Manager is the cornerstone of Microsoft Purview’s compliance capabilities. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} It acts as a risk assessment and recommendations engine, helping organizations navigate complex regulatory landscapes such as GDPR, HIPAA, and ISO 27001.

\item Compliance Manager provides structured assessments tailored to specific regulations. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} Each assessment is composed of controls—some managed by Microsoft, others by the customer—that define the requirements for compliance.

\item The Compliance Score quantifies how well an organization meets regulatory requirements. \textbf{(True/False)}
...
\item Data Explorer helps admins discover where sensitive data resides across the organization. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} It provides powerful tools to visualize, filter, and analyze sensitive information across emails, documents, chats, and cloud storage.

\item Data Explorer supports filtering by which of the following? \textbf{(Select all that apply)}
\begin{enumerate}[label=\alph*., leftmargin=1.5em]
\item Location
\item Sensitivity label
\item Content type
...
\textbf{Explanation:} These filters help admins quickly pinpoint areas of concern and assess data exposure risks before implementing new security policies.

\item DSPM for AI is a critical capability that enables admins to discover, monitor, and control how AI interacts with sensitive data. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} It tracks where AI-generated content is stored, how it’s labeled, and who can access it.

\item Shadow AI usage refers to the unsanctioned or unauthorized use of AI tools, applications, or models by employees without formal approval or oversight. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} It creates risks for security, compliance, and operational efficiency similar to shadow IT.

\item DSPM for AI can detect AI interactions such as Copilot summarizing legal contracts containing regulated information. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} Admins can define rules to prevent AI from accessing certain content types and mitigate risks through encryption or restricted access.
...
\item Content Search enables admins to search across mailboxes, SharePoint sites, OneDrive, and Teams using keywords, sender information, dates, and sensitivity labels. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} The platform supports both Keyword Query Language and graphical user interface filters.

\item eDiscovery in Microsoft Purview is available in Standard and Premium editions. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} eDiscovery (Standard) offers basic search, export, and legal hold features. eDiscovery (Premium) adds advanced capabilities such as case management, review sets, analytics, and redaction.

\item Legal hold prevents data from being altered or deleted during an investigation. \textbf{(True/False)}

\textbf{Answer:} True.

\textbf{Explanation:} Review sets allow admins to organize and analyze collected content to identify key evidence.

\item Match each tool with its primary purpose.

\begin{center}
\begin{tabular}{>{\raggedright\arraybackslash}p{0.35\textwidth} >{\raggedright\arraybackslash}p{0.55\textwidth}}
\toprule
\textbf{Tool} & \textbf{Primary Purpose} \\
\midrule
Compliance Manager & Risk assessment and compliance improvement tracking \\
Data Explorer & Discover and visualize sensitive data locations \\
DSPM for AI & Monitor and manage AI interactions with sensitive data \\
eDiscovery (Premium) & Advanced case management, analytics, and redaction \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Answer:} Compliance Manager \textrightarrow{} Risk assessment and compliance improvement tracking; Data Explorer \textrightarrow{} Discover and visualize sensitive data locations; DSPM for AI \textrightarrow{} Monitor and manage AI interactions with sensitive data; eDiscovery (Premium) \textrightarrow{} Advanced case management, analytics, and redaction.

\textbf{Explanation:} Each tool addresses a specific aspect of compliance, data discovery, AI governance, and legal investigations within Microsoft Purview.

\item Scenario: An organization must evaluate gaps for GDPR compliance and track remediation steps. Which tool should be used?
\begin{enumerate}[label=\alph*., leftmargin=1.5em]
\item Compliance Manager
\item Data Explorer
\item DSPM for AI
...
\textbf{Explanation:} It offers prebuilt assessments, controls, improvement actions, and a Compliance Score tailored to regulations like GDPR.

\item Scenario: An admin needs to locate all documents containing Social Security Numbers that are shared externally. Which tool is most suitable?
\begin{enumerate}[label=\alph*., leftmargin=1.5em]
\item Data Explorer
\item Compliance Manager
\item eDiscovery (Standard)
...
\textbf{Explanation:} It scans for sensitive information types, applies filters, and shows ownership and sharing status.

\item Scenario: A legal team requires case management, analytics, and redaction for a complex investigation. Which edition of eDiscovery should be selected?
\begin{enumerate}[label=\alph*., leftmargin=1.5em]
\item eDiscovery (Premium)
\item eDiscovery (Standard)
\item Content Search only
...
\textbf{Explanation:} Premium adds advanced features such as case management, review sets, analytics, and redaction.
