...
\begin{center}
\vspace*{\fill}
{\LARGE\bfseries Microsoft 365 Security Foundations\par}
\vspace*{\fill}
\end{center}
\addcontentsline{toc}{section}{Microsoft 365 Security Foundations}
\clearpage
...
\item \textbf{What is the primary goal of Data Loss Prevention (DLP) policies in this module?}
\begin{enumerate}[label=\Alph*.]
...
\end{enumerate}
\textbf{Answer: B}\\
\textbf{Explanation:} The module highlights PHS as commonly recommended in hybrid scenarios unless real-time on-prem validation is specifically required.
